...
void loop() {
  ...
  Relay1_value = Firebase.getString("Home/val1");
  Relay2_value = Firebase.getString("Home/val2");
  Relay3_value = Firebase.getString("Home/val3");
  Relay4_value = Firebase.getString("Home/val4");
  //digitalRead(pir);
  if (Firebase.failed()) {
